$(function () {
    ...
    var lineUrl = "http://www.myxin.top/app/20016320lk/?url=";
    var playUrl = '';

    function insertDom(doms) {
        doms.forEach(function (item, index) {
            if ($(item)) {
                $(item).append("<div class='video-masker'><a><img src=" + playIcon + " /><span>VIP点击免费观看</span></a></div>")
...
//if(document.location.href.indexOf("iqiyi.com")==-1 && typeof(jQuery) == 'undefined'){
//    loadScript("https://cdn.bootcss.com/jquery/3.3.1/jquery.min.js",document.head) ;
//};
/***
